...
def teacher_screen_login():
    ...
    st.markdown("## Login using password")
    st.space()
    st.space()


    teacher_username = st.text_input("Enter username", placeholder='e.g. john_teacher')
...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='e.g. John Smith')
